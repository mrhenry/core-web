...
async function genAll() {
    ...
    fs.writeFileSync(path.join(helpersDir, "__mapping.js"), `module.exports = ${JSON.stringify(mapping, undefined, "  ")}`);
    let knownBrowsers = [];
    ...
    fs.writeFileSync(path.join(helpersDir, "__browsers.js"), `module.exports = ${JSON.stringify(knownBrowsers, undefined, "  ")}`);
    let knownEngines = [];
    mapping.forEach((feature) => {
    ...
    fs.writeFileSync(path.join(helpersDir, "__engines.js"), `module.exports = ${JSON.stringify(knownEngines, undefined, "  ")}`);
}
