...
module.exports = [
	configBuilder({
		...
		target: [
			'web',
			'browserslist:Chrome 87 or Edge 87 or Firefox 83 or Opera 72 or Safari 14 or Samsung 13 or Android 81'
		],
		coreJsBrowsers: [
			'chrome >= 87',
			'edge >= 87',
	...
	configBuilder({
		...
		target: [
			'web',
			'browserslist:Chrome 39 or Firefox 83 or Opera 26 or Safari 8 or Samsung 13 or Android 4.4.4'
		],
		coreJsBrowsers: [
			'chrome >= 39',
			'firefox >= 34',
