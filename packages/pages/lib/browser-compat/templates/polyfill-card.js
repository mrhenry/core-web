	...
	<main id="main-content">
		<div class="section">
			<div class="wrapper">
				...
				<pre><code style="word-break: break-all;">import "@mrhenry/core-web/modules/${feature.polyfillName}.js";</code></pre>
			</div>
		</div>
...
function links(feature) {
	...
	if (feature.polyfillio && feature.polyfillio.baseDir) {
		list.push(
			html`
				<li>
					<a href="https://${path.join('github.com/mrhenry/polyfill-library/tree/main/polyfills/', feature.polyfillio.baseDir)}" target="_blank" rel="noopener">@mrhenry/polyfill-library</a>
				</li>
			`
		);
	}
